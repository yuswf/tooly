                ...
                <div className="relative flex h-16 items-center justify-between">
                    ...
                    <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                        <div className="flex justify-center gap-5 text-lg items-center relative ml-3">
                            <span className="font-bold">{clock || <Skeleton width={112} />}</span>
                            ...
                            {dropdown && (
                                <div
                                    id="dropdown"
                                    className="top-9 absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-[#1f2024] py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
